...
#exclude_hosts = ['im-planetlab-1.univ-reunion.fr','planetlab-1.imag.fr','planetlab2.research.nicta.com.au', 'planetlab2.singaren.net.sg', 'planetlab02.sys.virginia.edu', 'planetlab1.polito.it', 'planetlab2.cs.colorado.edu', 'mercury.silicon-valley.ru', 'pl2.bell-labs.fr', 'lim-planetlab-1.univ-reunion.fr']
...
def initialize_variables():
    ...
    success, failed, lns_cache_hit, retrans_count, total_processing_delay, total_reads, total_writes
    ...
    for line in lines:
        ...
        if tokens[0].startswith('<message>Success-Lookup'):
            ...
            try:
                ...
                host_tuples.append([name, lns, ns1, num_transmissions, latency, 'r', start_time - first_start, start_time - first_start + latency, num_restarts])
