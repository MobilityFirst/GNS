...
locality_parameter = 4    ## requests will be generated with locality parameter 1 to locality_parameter
first_mobile_name = 1000
number_mobiles = 10000 
number_updates = 200000  ## approx number of updates generated for mobile names
number_queries = 200000  ## approx number of lookups generated for mobile names

locality_percent =  1.0 #0.75
