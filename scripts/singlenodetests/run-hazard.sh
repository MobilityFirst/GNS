...
nohup java -ea -DgigapaxosConfig=conf/gigapaxos.gnsApp.hazard.properties -cp jars/GNS.jar edu.umass.cs.gnsserver.gnsApp.AppReconfigurableNode -test -configFile $SCRIPTS/ns_hazard.properties > NSlogfile 2>&1 &
