...
local_name_server_jar = '../../build/jars/GNRS.jar'              #Local name server jar
...
is_local = True                                    #Flag for indicating the execution environment
...
def main(argv):
    try:                                
        opts, args = getopt.getopt(argv, 'ab:c:d:e:fg:h:i:jk:l:m:n:o:p:qr:tv:w:x:y:z:', 
                                   ['local', 'id=', 'nsFile=', 'lnsFile=',
                                    ...
                                    'jar=', 'help', 'lookupRate=', 'updateRateMobile=', 
