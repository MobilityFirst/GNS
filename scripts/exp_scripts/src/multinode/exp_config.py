...
lookupTrace = get_lookup_folder(output_folder) # '/home/abhigyan/gnrs/ec2_data/workload/lookupTrace/'
updateTrace = get_update_folder(output_folder) #'/home/abhigyan/gnrs/ec2_data/workload/updateTrace/'
...
def initialize_env_variables(parser):
    ...
    if parser.has_option(ConfigParser.DEFAULTSECT, 'remote_folder'):
        global remote_folder, jar_file_remote, gns_output_logs, paxos_log_folder, db_folder
