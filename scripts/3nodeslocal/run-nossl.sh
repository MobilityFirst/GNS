...
# > NSlog 2>&1 &
java -ea -DgigapaxosConfig=conf/gigapaxos.gnsApp.properties -cp jars/GNS.jar edu.umass.cs.gnsserver.localnameserver.LocalNameServer -configFile $SCRIPTS/lns_nossl.properties &
# > LNSlog 2>&1 &
