...
java -Xmx2g -cp ../../build/jars/GNS.jar edu.umass.cs.gns.nsdesign.StartNameServer -id 5 -configFile ns.conf &
java -Xmx2g -cp ../../build/jars/GNS.jar edu.umass.cs.gns.nsdesign.StartNameServer -id 6 -configFile ns.conf &
