...
for index in range(len(lines)):
	...
	cmd = 'nohup java -Xmx1024m -cp conf/contextServiceConf/context-nodoc-GNS.jar:dist/jars/GNS.jar edu.umass.cs.contextservice.examples.StartContextServiceNode '+node[0]+' &'
