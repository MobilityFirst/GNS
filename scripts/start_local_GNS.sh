...
java -cp ../dist/GNS.jar edu.umass.cs.gns.main.StartNameServer -id 127.0.0.1 -nsfile ../conf/singleNStest/node_config_1ns_1lns -singleNS -activeCodeWorkerCount 1 &
#
