#
java -ea -cp ../../dist/GNS.jar edu.umass.cs.gns.newApp.AppReconfigurableNode -test -nsfile ../../conf/single-server-info -consoleOutputLevel INFO -debug -demandProfileClass edu.umass.cs.gns.newApp.NullDemandProfile &
