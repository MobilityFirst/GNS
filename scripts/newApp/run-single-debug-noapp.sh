#
java -ea -cp ../../dist/GNS.jar edu.umass.cs.gns.newApp.AppReconfigurableNode -test -nsfile ../../conf/single-server-info -consoleOutputLevel INFO  -demandProfileClass edu.umass.cs.gns.newApp.NullDemandProfile -debugAR -debugPaxos -debugRecon &
