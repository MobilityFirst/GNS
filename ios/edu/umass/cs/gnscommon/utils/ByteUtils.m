...
+ (IOSByteArray *)hexStringToByteArrayWithNSString:(NSString *)s {
  return EduUmassCsGnscommonUtilsByteUtils_hexStringToByteArrayWithNSString_(s);
}

+ (NSString *)toHexWithByteArray:(IOSByteArray *)bytes {
  return EduUmassCsGnscommonUtilsByteUtils_toHexWithByteArray_(bytes);
}

+ (NSString *)toHexWithByte:(jbyte)b {
  return EduUmassCsGnscommonUtilsByteUtils_toHexWithByte_(b);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[12].selector = @selector(hexStringToByteArrayWithNSString:);
  methods[13].selector = @selector(toHexWithByteArray:);
  methods[14].selector = @selector(toHexWithByte:);
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "ShortToByteArray", "I[BI", "I[B", "BAToInt", "[BI", "[B", "ByteArrayToInt", "IntToByteArray", "ByteArrayToShort", "byteArrayToLong", "hexStringToByteArray", "LNSString;", "toHex", "B" };
  static const J2ObjcClassInfo _EduUmassCsGnscommonUtilsByteUtils = { "ByteUtils", "edu.umass.cs.gnscommon.utils", ptrTable, methods, NULL, 7, 0x1, 15, 0, -1, -1, -1, -1, -1 };
...
IOSByteArray *EduUmassCsGnscommonUtilsByteUtils_hexStringToByteArrayWithNSString_(NSString *s) {
  EduUmassCsGnscommonUtilsByteUtils_initialize();
...
NSString *EduUmassCsGnscommonUtilsByteUtils_toHexWithByteArray_(IOSByteArray *bytes) {
  EduUmassCsGnscommonUtilsByteUtils_initialize();
  JavaLangStringBuilder *sb = create_JavaLangStringBuilder_init();
  for (jint i = 0; i < ((IOSByteArray *) nil_chk(bytes))->size_; i++) {
    [sb appendWithNSString:EduUmassCsGnscommonUtilsByteUtils_toHexWithByte_(IOSByteArray_Get(bytes, i))];
  }
  return [sb description];
}

NSString *EduUmassCsGnscommonUtilsByteUtils_toHexWithByte_(jbyte b) {
  EduUmassCsGnscommonUtilsByteUtils_initialize();
  return NSString_java_formatWithNSString_withNSObjectArray_(@"%02X", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangByte_valueOfWithByte_(b) } count:1 type:NSObject_class_()]);
}
