...
rm -rf ./edu
~/Downloads/j2objc/dist/j2objc --build-closure -d . -sourcepath ../src:../../gig_ios/src -classpath /Users/kanantharamu/gig_ios/lib/json-smart-1.2.jar ../src/edu/umass/cs/gnsclient/client/GNSClient.java
