/**
 * Mobility First - Global Name Service (GNS) Copyright (C) 2013
 * University of Massachusetts - Emmanuel Cecchet. Contact: support@gns.name
 *
 ...
 * the License.
 *
 * Initial developer(s): Emmanuel Cecchet. Contributor(s): Westy
