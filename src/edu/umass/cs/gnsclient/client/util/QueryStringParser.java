...
public class QueryStringParser
{
   ...
   * 
   * @return <code>true</code> if a parameter has been found; <code>false</code>
  ...
  /**
   * Search for a parameter with a name in a given collection. This method
   * iterates over the parameters until a parameter with a matching name has
  ...
  /**
   * Get the name of the current parameter. Calling this method is only allowed
   * if {@link #next()} has been called previously and the result of this call
   * was <code>true</code>. Otherwise the result of this method is undefined.
   * 
  ...
  /**
   * Get the value of the current parameter. Calling this method is only allowed
   * if {@link #next()} has been called previously and the result of this call
   * was <code>true</code>. Otherwise the result of this method is undefined.
   * 
  ...
  public String getValue()
  {
    if (paramValue == null)
    {
      ...
      try
      {
        paramValue = URIEncoderDecoder.decode(queryString.substring(
            paramNameEnd + 1, paramEnd));
      }
      catch (UnsupportedEncodingException ex)
      {
        // TODO: URIEncoderDecoder.decode should be changed to not throw
        // UnsupportedEncodingException since this actually never happens (the
        // charset
