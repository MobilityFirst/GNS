...
//
  ...
  Append(110, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.Append.class,
          ...
          "Appends the value onto the key value pair for the given GUID. Treats the list as a set, removing duplicates. Field must be writeable by the WRITER guid.",
  ...
  AppendList(111, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.AppendList.class,
          GNSCommand.ResultType.NULL, true, false,
          "Appends the value onto of this key value pair for the given GUID. Value is a list of items formated as a JSON list. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  AppendListUnsigned(113, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.AppendListUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Appends the value onto of this key value pair for the given GUID. Value is a list of items formated as a JSON list. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  AppendListWithDuplication(114, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.AppendListWithDuplication.class,
          GNSCommand.ResultType.NULL, true, false,
          "Appends the values onto this key value pair for the given GUID. Treats the list as a list, allows dupicates. Value is a list of items formated as a JSON list. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  AppendListWithDuplicationUnsigned(116, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.AppendListWithDuplicationUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Appends the values onto of this key value pair for the given GUID. Treats the list as a list, allows dupicate. Value is a list of items formated as a JSON list. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  AppendOrCreate(120, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.AppendOrCreate.class,
          GNSCommand.ResultType.NULL, true, false,
          "Adds a key value pair to the GNS for the given GUID if it doesn't not exist otherwise append value onto existing value. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  AppendOrCreateList(121, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.AppendOrCreateList.class,
          GNSCommand.ResultType.NULL, true, false,
          "Adds a key value pair to the GNS for the given GUID if it doesn not exist otherwise appends values onto existing value.Value is a list of items formated as a JSON list. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  AppendOrCreateListUnsigned(123, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.AppendOrCreateListUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Adds a key value pair to the GNS for the given GUID if it doesn not exist otherwise appends values onto existing value. Value is a list of items formated as a JSON list. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  AppendOrCreateUnsigned(125, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.AppendOrCreateUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Adds a key value pair to the GNS for the given GUID if it doesn't not exist otherwise append value onto existing value. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  AppendUnsigned(131, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.AppendUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Appends the value onto the key value pair for the given GUID. Treats the list as a set, removing duplicates Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  AppendWithDuplication(132, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.AppendWithDuplication.class,
          GNSCommand.ResultType.NULL, true, false,
          "Appends the values onto this key value pair for the given GUID. Treats the list as a list, allows dupicates. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  AppendWithDuplicationUnsigned(134, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.AppendWithDuplicationUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Appends the values onto this key value pair for the given GUID. Treats the list as a list, allows dupicates. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  Clear(140, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.Clear.class,
          GNSCommand.ResultType.NULL, true, false,
          "Clears the key value pair from the GNS for the given GUID. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.WRITER,
            GNSCommandProtocol.SIGNATURE,
  ...
  ClearUnsigned(142, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ClearUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Clears the key value pair from the GNS for the given guid after authenticating that GUID making request has access authority. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.WRITER}),
  ...
  CreateList(153, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.CreateList.class,
          GNSCommand.ResultType.NULL, true, false,
          "Adds a key value pair to the GNS for the given GUID. Value is a list of items formated as a JSON list. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  Read(160, CommandCategory.READ, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.Read.class,
          ...
          "Returns a key value pair from the GNS for the given guid after authenticating that READER making request has access authority. Field can use dot notation to access subfields. Specify +ALL+ as the <field> to return all fields as a JSON object.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
  ...
  ReadUnsigned(162, CommandCategory.READ, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReadUnsigned.class,
          GNSCommand.ResultType.MAP, true, false,
          "Returns one key value pair from the GNS. Does not require authentication but field must be set to be readable by everyone or the magic token needs to be supplied. Specify +ALL+ as the <field> to return all fields. ",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD}),
  ReadMultiField(163, CommandCategory.READ, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReadMultiField.class,
          GNSCommand.ResultType.MAP, true, false,
          "Returns multiple key value pairs from the GNS for the given guid after authenticating that READER making request has access authority. Fields can use dot notation to access subfields.",
          new String[]{GNSCommandProtocol.GUID,
  ...
  ReadArray(170, CommandCategory.READ, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReadArray.class,
          ...
          "Returns one key value pair from the GNS for the given guid after authenticating that READER making request has access authority. Values are always returned as a JSON list. Specify +ALL+ as the <field> to return all fields as a JSON object.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.READER,
            GNSCommandProtocol.SIGNATURE,
  ...
  ReadArrayOne(171, CommandCategory.READ, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReadArrayOne.class,
          ...
          "Returns one key value pair from the GNS for the given guid after authenticating that the READER has access authority. Treats the value of key value pair as a singleton item and returns that item. Specify +ALL+ as the <field> to return all fields. ",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.READER,
            GNSCommandProtocol.SIGNATURE,
  ...
  ReadArrayOneUnsigned(173, CommandCategory.READ, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReadArrayOneUnsigned.class,
          GNSCommand.ResultType.STRING, true, false,
          "Returns one key value pair from the GNS for the given guid. Does not require authentication but field must be set to be readable by everyone. Treats the value of key value pair as a singleton item and returns that item. Specify +ALL+ as the <field> to return all fields. ",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD}),
  ReadArrayUnsigned(175, CommandCategory.READ, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReadArrayUnsigned.class,
          GNSCommand.ResultType.LIST, true, false,
          "Returns one key value pair from the GNS. Does not require authentication but field must be set to be readable by everyone. Values are always returned as a JSON list. Specify +ALL+ as the <field> to return all fields. ",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD}),
  Remove(180, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.Remove.class,
          GNSCommand.ResultType.NULL, true, false,
          "Returns one key value pair from the GNS for the given guid after authenticating that WRITER making request has access authority. Values are always returned as a JSON list. Specify +ALL+ as the <field> to return all fields as a JSON object.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  RemoveList(181, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.RemoveList.class,
          GNSCommand.ResultType.NULL, true, false,
          "Removes all the values from the key value pair for the given GUID. Value is a list of items formated as a JSON list. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  RemoveListUnsigned(183, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.RemoveListUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Removes all the values from the key value pair for the given GUID. Value is a list of items formated as a JSON list. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  RemoveUnsigned(185, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.RemoveUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Removes the value from the key value pair for the given GUID. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  Replace(190, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.Replace.class,
          GNSCommand.ResultType.NULL, true, false,
          "Replaces the current value key value pair from the GNS for the given guid. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  ReplaceList(191, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReplaceList.class,
          GNSCommand.ResultType.NULL, true, false,
          "Replaces the current value key value pair from the GNS for the given guid with the given values. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  ReplaceListUnsigned(193, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReplaceListUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Replaces the current value key value pair from the GNS for the given guid with the given values. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  ReplaceOrCreate(210, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReplaceOrCreate.class,
          GNSCommand.ResultType.NULL, true, false,
          "Adds a key value pair to the GNS for the given GUID if it doesn not exist otherwise replaces the value of this key value pair for the given GUID. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  ReplaceOrCreateList(211, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReplaceOrCreateList.class,
          GNSCommand.ResultType.NULL, true, false,
          "Adds a key value pair to the GNS for the given GUID if it does not exist otherwise replaces the value of this key value pair for the given GUID with the value. Value is a list of items formated as a JSON list. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.WRITER,
  ...
  ReplaceOrCreateListUnsigned(213, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReplaceOrCreateListUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Adds a key value pair to the GNS for the given GUID if it does not exist otherwise replaces the value of this key value pair for the given GUID with the value. Value is a list of items formated as a JSON list. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  ReplaceOrCreateUnsigned(215, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReplaceOrCreateUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Adds a key value pair to the GNS for the given GUID if it doesn not exist otherwise replaces the value of this key value pair for the given GUID. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  ReplaceUnsigned(217, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReplaceUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Replaces the current value key value pair from the GNS for the given guid. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE}),
  ReplaceUserJSON(220, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReplaceUserJSON.class,
          GNSCommand.ResultType.NULL, true, false,
          "Replaces existing fields in JSON record with the given JSONObject's fields. Doesn't touch top-level fields that aren't in the given JSONObject.",
          new String[]{GNSCommandProtocol.GUID,
  ...
  ReplaceUserJSONUnsigned(221, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.ReplaceUserJSONUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Replaces existing fields in JSON record with the given JSONObject's fields.  Field must be world writeable or magic must be supplied as this command does not specify the writer and is not signed.Doesn't touch top-level fields that aren't in the given JSONObject.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.USER_JSON,
            GNSCommandProtocol.WRITER}),
  ...
  Substitute(231, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.Substitute.class,
          GNSCommand.ResultType.NULL, true, false,
          "Replaces OLD_VALUE with newvalue in the key value pair for the given GUID. See below for more on the signature. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
  ...
  SubstituteList(232, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.SubstituteList.class,
          GNSCommand.ResultType.NULL, true, false,
          "Replaces OLD_VALUE with newvalue in the key value pair for the given GUID. Value is a list of items formated as a JSON list. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.OLD_VALUE,
  ...
  SubstituteListUnsigned(234, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.SubstituteListUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Replaces OLD_VALUE with newvalue in the key value pair for the given GUID. Value is a list of items formated as a JSON list. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.OLD_VALUE}),
  SubstituteUnsigned(236, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.SubstituteUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Replaces OLD_VALUE with newvalue in the key value pair for the given GUID. See below for more on the signature. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
            GNSCommandProtocol.OLD_VALUE}),
  RemoveField(240, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.RemoveField.class,
          GNSCommand.ResultType.NULL, true, false,
          "Removes the key value pair from the GNS for the given guid after authenticating that WRITER making request has access authority.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.WRITER,
            GNSCommandProtocol.SIGNATURE,
  ...
  RemoveFieldUnsigned(242, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.RemoveFieldUnsigned.class,
          GNSCommand.ResultType.NULL, true, false,
          "Removes the key value pair from the GNS for the given guid. Field must be world writeable as this command does not specify the writer and is not signed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.WRITER}),
  Set(250, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.data.Set.class,
          GNSCommand.ResultType.NULL, true, false,
          "Replaces element N with newvalue in the key value pair for the given GUID. Field must be writeable by the WRITER guid.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.VALUE,
  ...
  SelectGroupLookupQuery(311, CommandCategory.SELECT, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.select.SelectGroupLookupQuery.class,
          GNSCommand.ResultType.LIST, false, false,
          "Returns all records for a group guid that was previously setup with a query. For details see http://gns.name/wiki/index.php/Query_Syntax Values are returned as a JSON array of JSON Objects.",
          new String[]{GNSCommandProtocol.GUID}),
  SelectGroupSetupQuery(312, CommandCategory.SELECT, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.select.SelectGroupSetupQuery.class,
          GNSCommand.ResultType.LIST, false, false,
          "Initializes a new group guid to automatically update and maintain all records that satisfy the query.For details see http://gns.name/wiki/index.php/Query_Syntax Values are returned as a JSON array of JSON Objects.",
          new String[]{GNSCommandProtocol.GUID,
  ...
  SelectGroupSetupQueryWithGuid(313, CommandCategory.SELECT, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.select.SelectGroupSetupQueryWithGuid.class,
          GNSCommand.ResultType.LIST, false, false,
          "Initializes the given group guid to automatically update and maintain all records that satisfy the query.For details see http://gns.name/wiki/index.php/Query_Syntax Values are returned as a JSON array of JSON Objects.",
  ...
  SelectGroupSetupQueryWithGuidAndInterval(314, CommandCategory.SELECT, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.select.SelectGroupSetupQueryWithGuidAndInterval.class,
          GNSCommand.ResultType.LIST, false, false,
          "Initializes the group guid to automatically update and maintain all records that satisfy the query.Interval is the minimum refresh interval of the query - lookups happening more quickly than thisinterval will retrieve a stale value.For details see http://gns.name/wiki/index.php/Query_Syntax Values are returned as a JSON array of JSON Objects.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.QUERY,
  ...
  SelectGroupSetupQueryWithInterval(315, CommandCategory.SELECT, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.select.SelectGroupSetupQueryWithInterval.class,
          GNSCommand.ResultType.LIST, false, false,
          "Initializes a new group guid to automatically update and maintain all records that satisfy the query.Interval is the minimum refresh interval of the query - lookups happening more quickly than thisinterval will retrieve a stale value.For details see http://gns.name/wiki/index.php/Query_Syntax Values are returned as a JSON array of JSON Objects.",
          new String[]{GNSCommandProtocol.QUERY,
            GNSCommandProtocol.INTERVAL}),
  SelectNear(320, CommandCategory.SELECT, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.select.SelectNear.class,
          GNSCommand.ResultType.LIST, false, false,
          "Key must be a GeoSpatial field. Return all fields that are within max distance of value.Value is a point specified as a JSONArray string tuple: [LONG, LAT]. Max Distance is in meters.",
          new String[]{GNSCommandProtocol.FIELD,
  ...
  SelectWithin(321, CommandCategory.SELECT, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.select.SelectWithin.class,
          GNSCommand.ResultType.LIST, false, false,
          "Key must be a GeoSpatial field. Returns all records whose fields are within value which is a bounding box specified. Bounding box is a nested JSONArray string tuple of paired tuples: [[LONG_UL, LAT_UL],[LONG_BR, LAT_BR]]",
          new String[]{GNSCommandProtocol.FIELD,
  ...
  SelectQuery(322, CommandCategory.SELECT, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.select.SelectQuery.class,
          GNSCommand.ResultType.LIST, false, false,
          "Returns all records that satisfy the query. For details see http://gns.name/wiki/index.php/Query_Syntax Values are returned as a JSON array of JSON Objects.",
          new String[]{GNSCommandProtocol.QUERY}),
  AddAlias(410, CommandCategory.CREATE_DELETE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.AddAlias.class,
          ...
          "Adds a additional human readble name to the account associated with the GUID. Must be signed by the guid. Returns +BADGUID+ if the GUID has not been registered.",
          new String[]{GNSCommandProtocol.GUID,
  ...
  AddGuid(411, CommandCategory.CREATE_DELETE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.AddGuid.class,
          GNSCommand.ResultType.NULL, false, false,
          "Adds a GUID to the account associated with the GUID. Must be signed by the guid. Returns +BADGUID+ if the GUID has not been registered.",
  ...
  AddMultipleGuids(412, CommandCategory.CREATE_DELETE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.AddMultipleGuids.class,
          GNSCommand.ResultType.NULL, false, false,
          "Creates multiple guids for the account associated with the account guid. Must be signed by the account guid. Returns +BADGUID+ if the account guid has not been registered.",
  ...
  AddMultipleGuidsFast(413, CommandCategory.CREATE_DELETE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.AddMultipleGuidsFast.class,
          GNSCommand.ResultType.NULL, false, false,
          "Creates multiple guids for the account associated with the account guid. Must be signed by the account guid. The created guids can only be accessed using the account guid because the haveno private key info stored on the client.Returns +BADGUID+ if the account guid has not been registered.",
          new String[]{GNSCommandProtocol.NAMES,
            GNSCommandProtocol.GUID,
            GNSCommandProtocol.SIGNATURE,
            GNSCommandProtocol.SIGNATUREFULLMESSAGE}),
  ...
  LookupAccountRecord(420, CommandCategory.SYSTEM_LOOKUP, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.LookupAccountRecord.class,
          GNSCommand.ResultType.MAP, true, false,
          "Returns the account info associated with the given GUID. Returns +BADGUID+ if the GUID has not been registered.",
          new String[]{GNSCommandProtocol.GUID}),
  ...
  LookupGuid(422, CommandCategory.SYSTEM_LOOKUP, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.LookupGuid.class,
          GNSCommand.ResultType.STRING, true, false,
          "Returns the guid associated with for the human readable name. Returns +BADACCOUNT+ if the GUID has not been registered.",
          new String[]{GNSCommandProtocol.NAME}),
  ...
  LookupGuidRecord(424, CommandCategory.SYSTEM_LOOKUP, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.LookupGuidRecord.class,
          GNSCommand.ResultType.MAP, true, false,
          "Returns human readable name and public key associated with the given GUID. Returns +BADGUID+ if the GUID has not been registered.",
          new String[]{GNSCommandProtocol.GUID}),
  RegisterAccount(430, CommandCategory.CREATE_DELETE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.RegisterAccount.class,
          GNSCommand.ResultType.NULL, false, false,
          "Creates an account GUID associated with the human readable name and the supplied public key. Must be sign dwith the public key. Returns a guid.",
          new String[]{GNSCommandProtocol.NAME,
            GNSCommandProtocol.PUBLIC_KEY,
  ...
  RemoveAccount(440, CommandCategory.CREATE_DELETE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.RemoveAccount.class,
          GNSCommand.ResultType.NULL, false, false,
          "Removes the account GUID associated with the human readable name. Must be signed by the guid.",
          new String[]{GNSCommandProtocol.NAME,
            GNSCommandProtocol.GUID,
            GNSCommandProtocol.SIGNATURE,
            GNSCommandProtocol.SIGNATUREFULLMESSAGE}),
  RemoveAlias(441, CommandCategory.CREATE_DELETE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.RemoveAlias.class,
          GNSCommand.ResultType.NULL, false, false,
          "Removes the alias from the account associated with the GUID. Must be signed by the guid. Returns +BADGUID+ if the GUID has not been registered.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.NAME,
            GNSCommandProtocol.SIGNATURE,
            GNSCommandProtocol.SIGNATUREFULLMESSAGE}),
  RemoveGuid(442, CommandCategory.CREATE_DELETE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.RemoveGuid.class,
          GNSCommand.ResultType.NULL, false, false,
          "Removes the GUID from the account associated with the ACCOUNT_GUID. Must be signed by the account guid or the guid if account guid is not provided. Returns +BADGUID+ if the GUID has not been registered.",
  ...
  RetrieveAliases(444, CommandCategory.SYSTEM_LOOKUP, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.account.RetrieveAliases.class,
          GNSCommand.ResultType.LIST, true, false,
          "Retrieves all aliases for the account associated with the GUID. Must be signed by the guid. Returns +BADGUID+ if the GUID has not been registered.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.SIGNATURE,
            GNSCommandProtocol.SIGNATUREFULLMESSAGE}),
  ...
  AclRemove(512, CommandCategory.UPDATE, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.acl.AclRemove.class,
          GNSCommand.ResultType.NULL, true, false,
          "Updates the access control list of the given GUID's field to remove the accesser guid.Accessor should be the guid or group guid to be removed.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.FIELD,
            GNSCommandProtocol.ACCESSER,
            GNSCommandProtocol.WRITER,
  ...
  AddMembersToGroup(610, CommandCategory.OTHER, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.group.AddMembersToGroup.class,
          GNSCommand.ResultType.NULL, false, false,
          "Adds the member guids to the group specified by guid. Writer guid needs to have write access and sign the command.",
          new String[]{GNSCommandProtocol.GUID,
  ...
  AddToGroup(612, CommandCategory.OTHER, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.group.AddToGroup.class,
          GNSCommand.ResultType.NULL, false, false,
          "Adds the member guid to the group specified by guid. Writer guid needs to have write access and sign the command.",
          new String[]{GNSCommandProtocol.GUID,
  ...
  GetGroupMembers(614, CommandCategory.SYSTEM_LOOKUP, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.group.GetGroupMembers.class,
          GNSCommand.ResultType.LIST, true, false,
          "Returns the members of the group formatted as a JSON Array. Reader guid needs to have read access and sign the command.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.READER,
            GNSCommandProtocol.SIGNATURE,
            GNSCommandProtocol.SIGNATUREFULLMESSAGE}),
  ...
  GetGroups(616, CommandCategory.SYSTEM_LOOKUP, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.group.GetGroups.class,
          GNSCommand.ResultType.LIST, true, false,
          "Returns the groups that a guid is a member of formatted as a JSON Array. Reader guid needs to have read access and sign the command.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.READER,
            GNSCommandProtocol.SIGNATURE,
            GNSCommandProtocol.SIGNATUREFULLMESSAGE}),
  ...
  RemoveFromGroup(620, CommandCategory.OTHER, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.group.RemoveFromGroup.class,
          GNSCommand.ResultType.NULL, false, false,
          "Removes the member guid from the group specified by guid. Writer guid needs to have write access and sign the command.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.MEMBER,
            GNSCommandProtocol.WRITER,
            GNSCommandProtocol.SIGNATURE,
  ...
  RemoveMembersFromGroup(622, CommandCategory.OTHER, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.group.RemoveMembersFromGroup.class,
          GNSCommand.ResultType.NULL, false, false,
          "Removes the member guids from the group specified by guid. Writer guid needs to have write access and sign the command.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.MEMBERS,
            GNSCommandProtocol.WRITER,
            GNSCommandProtocol.SIGNATURE,
  ...
  GetParameter(720, CommandCategory.OTHER, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.admin.GetParameter.class,
          GNSCommand.ResultType.STRING, true, true,
          "Returns one key value pair from the GNS for the given guid after authenticating that GUID making request has access authority. Values are always returned as a JSON list. Specify +ALL+ as the <field> to return all fields as a JSON object.",
          new String[]{GNSCommandProtocol.FIELD}),
  ...
  AddTag(731, CommandCategory.OTHER, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.admin.AddTag.class,
          GNSCommand.ResultType.NULL, true, false,
          "Adds a tag to the guid. Must be signed by the guid. Returns +BADGUID+ if the GUID has not been registered.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.NAME,
            GNSCommandProtocol.SIGNATURE,
            GNSCommandProtocol.SIGNATUREFULLMESSAGE}),
  ...
  RemoveTag(732, CommandCategory.OTHER, edu.umass.cs.gnsserver.gnsapp.clientCommandProcessor.commands.admin.RemoveTag.class,
          GNSCommand.ResultType.NULL, true, false,
          "Removes a tag from the guid. Must be signed by the guid. Returns +BADGUID+ if the GUID has not been registered.",
          new String[]{GNSCommandProtocol.GUID,
            GNSCommandProtocol.NAME,
            GNSCommandProtocol.SIGNATURE,
            GNSCommandProtocol.SIGNATUREFULLMESSAGE}),
