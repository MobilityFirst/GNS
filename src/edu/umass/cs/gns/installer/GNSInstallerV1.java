 ...
 * Typical use:
 ...
 java -cp GNS.jar edu.umass.cs.gns.installer.GNSInstallerV1 -install gns_dev
...
//    SSHClient.scpTo(userName, hostname, keyFile, nsConfFileLocation, nsConfFileName);
  ...
  static class UpdateThread extends Thread {
    ...
    public void run() {
      try {
        GNSInstallerV1.updateAndRunGNS(id, hostname, action, removeLogs, deleteDatabase, scriptFile);
