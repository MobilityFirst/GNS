...
public class CommandDefs {
  ...
  private static String[] commands = new String[]{
    ...
    "edu.umass.cs.gns.commands.data.ReadMultiField",
    ...
    "edu.umass.cs.gns.commands.data.SelectGroupSetupQueryWithGuid",
    "edu.umass.cs.gns.commands.data.SelectGroupSetupQueryWithGuidAndInterval",
