...
public abstract class PaxosPacket implements PacketInterface {
	...
	public static enum Keys {
		PAXOS_PACKET_TYPE, PAXOS_ID, PAXOS_VERSION, SLOT, MEDIAN_CHECKPOINTED_SLOT, ACCEPTED_MAP, RECOVERY, MAX_CHECKPOINTED_SLOT, STATE, MAX_SLOT, MISSING, IS_MISSING_TOO_MUCH, FIRST_UNDECIDED_SLOT
	}
