...
public abstract class BasicPacketDemultiplexer {
	...
	private ScheduledThreadPoolExecutor executor = new ScheduledThreadPoolExecutor(10); // FIXME: Not sure on what basis to limit number of threads
	private HashMap<Packet.PacketType, Boolean> demuxMap = new HashMap<Packet.PacketType, Boolean>();
