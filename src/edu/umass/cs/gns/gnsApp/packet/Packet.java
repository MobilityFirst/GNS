...
//          return new edu.umass.cs.gns.gnsApp.packet.AddRecordPacket<String>(json, unstringer); // after adding name, active replica confirms to replica controller
        // new client
        case COMMAND:
          return new edu.umass.cs.gns.gnsApp.packet.CommandPacket(json);
...
//          return new edu.umass.cs.gns.gnsApp.packet.RemoveRecordPacket<String>(json, unstringer);
        ...
        case ADMIN_REQUEST:
          return new edu.umass.cs.gns.gnsApp.packet.admin.AdminRequestPacket(json);
        case ADMIN_RESPONSE:
          return new edu.umass.cs.gns.gnsApp.packet.admin.AdminResponsePacket(json);
        // status
        case STATUS:
          return new edu.umass.cs.gns.gnsApp.packet.admin.StatusPacket(json);
        case TRAFFIC_STATUS:
          return new edu.umass.cs.gns.gnsApp.packet.admin.TrafficStatusPacket(json);
        case STATUS_INIT:
