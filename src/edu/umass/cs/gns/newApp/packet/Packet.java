...
public class Packet {
  ...
  public enum PacketType implements IntegerPacketType {
    ...
    DNS(1, "edu.umass.cs.gns.newApp.packet.DNSPacket"),
    // Add
    ...
    COMMAND_RETURN_VALUE(8, "edu.umass.cs.gns.newApp.packet.CommandValueReturnPacket"),
    // Remove
    ...
    // Lookup actives
    REQUEST_ACTIVES(30, "edu.umass.cs.gns.newApp.packet.RequestActivesPacket"),
    // Admin:
    DUMP_REQUEST(40, "edu.umass.cs.gns.newApp.packet.admin.DumpRequestPacket"),
    SENTINAL(41, "edu.umass.cs.gns.newApp.packet.admin.SentinalPacket"),
    ADMIN_REQUEST(42, "edu.umass.cs.gns.newApp.packet.admin.AdminRequestPacket"),
    ADMIN_RESPONSE(43, "edu.umass.cs.gns.newApp.packet.admin.AdminResponsePacket"),
    // status
    STATUS(50, "edu.umass.cs.gns.newApp.packet.admin.StatusPacket"),
    TRAFFIC_STATUS(51, "edu.umass.cs.gns.newApp.packet.admin.TrafficStatusPacket"),
    STATUS_INIT(52, "edu.umass.cs.gns.newApp.packet.admin.StatusInitPacket"),
    // select
    SELECT_REQUEST(70, "edu.umass.cs.gns.newApp.packet.SelectRequestPacket"),
    SELECT_RESPONSE(71, "edu.umass.cs.gns.newApp.packet.SelectResponsePacket"),
    // stats collection for names
    NAMESERVER_SELECTION(80, "edu.umass.cs.gns.newApp.packet.deprecated.NameServerSelectionPacket"),
    //ACTIVE_NAMESERVER_INFO(83, "edu.umass.cs.gns.newApp.packet.ActiveNameServerInfoPacket"),
    // paxos
    ...
    //
    NEW_ACTIVE_START(104, "edu.umass.cs.gns.newApp.packet.deprecated.NewActiveSetStartupPacket"),
    NEW_ACTIVE_START_FORWARD(105, "edu.umass.cs.gns.newApp.packet.deprecated.NewActiveSetStartupPacket"),
    NEW_ACTIVE_START_RESPONSE(106, "edu.umass.cs.gns.newApp.packet.deprecated.NewActiveSetStartupPacket"),
    NEW_ACTIVE_START_CONFIRM_TO_PRIMARY(107, "edu.umass.cs.gns.newApp.packet.deprecated.NewActiveSetStartupPacket"),
    NEW_ACTIVE_START_PREV_VALUE_REQUEST(108, "edu.umass.cs.gns.newApp.packet.deprecated.NewActiveSetStartupPacket"),
    NEW_ACTIVE_START_PREV_VALUE_RESPONSE(109, "edu.umass.cs.gns.newApp.packet.deprecated.NewActiveSetStartupPacket"),
    GROUP_CHANGE_COMPLETE(110, "edu.umass.cs.gns.newApp.packet.deprecated.GroupChangeCompletePacket"),
    // coordination
  ...
  public static Object createInstance(JSONObject json, Stringifiable<String> unstringer)
    ...
    try {
      switch (getPacketType(json)) {
        ...
        case ADMIN_REQUEST:
          return new edu.umass.cs.gns.newApp.packet.admin.AdminRequestPacket(json);
        case ADMIN_RESPONSE:
          return new edu.umass.cs.gns.newApp.packet.admin.AdminResponsePacket(json);
        // status
        case STATUS:
          return new edu.umass.cs.gns.newApp.packet.admin.StatusPacket(json);
        case TRAFFIC_STATUS:
          return new edu.umass.cs.gns.newApp.packet.admin.TrafficStatusPacket(json);
        case STATUS_INIT:
...
//          return new edu.umass.cs.gns.newApp.packet.ActiveNameServerInfoPacket(json, unstringer);
        // paxos
        case PAXOS_PACKET:
          return null;
        case STOP:
          return new edu.umass.cs.gns.newApp.packet.StopPacket(json);
        case NOOP:
