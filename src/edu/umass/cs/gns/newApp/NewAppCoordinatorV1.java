 ...
 * @param <NodeIDType>
 */
public class NewAppCoordinatorV1<NodeIDType> extends AbstractReplicaCoordinator<NodeIDType> {

  private final NodeIDType nodeID;
  private final Stringifiable<NodeIDType> unstringer;
  private final PaxosManager<NodeIDType> paxosManager;

  NewAppCoordinatorV1(InterfaceReplicable app, Stringifiable<NodeIDType> unstringer, JSONMessenger<NodeIDType> messenge) {
    super(app, messenge);
