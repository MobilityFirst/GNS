...
/**
 * @author V. Arun
 * Based on code created by abhigyan on 11/14/13.
 * 
 ...
 * <p>
 */
public class WriteActiveNameServersRunningTask implements RCProtocolTask {
	...
	public WriteActiveNameServersRunningTask(String name, int version) {
		this.name = name;
