...
//    readFields.add(ReplicaControllerRecord.OLD_ACTIVE_NAMESERVERS_RUNNING);
    ...
    try {
      ...
      writeOldSActiveStoppedAndStartupNewActives(packet);
...
//      }
  ...
  public static void writeOldSActiveStoppedAndStartupNewActives(OldActiveSetStopPacket packet) {
...
//              confirmPacket.getLocalNameServerId(), GNS.PortType.LNS_UDP_PORT);
  ...
  private static ArrayList<Field> getGetOldActiveStoppedFields() {
    synchronized (getOldActiveStoppedFields) {
      ...
      getOldActiveStoppedFields.add(ReplicaControllerRecord.OLD_ACTIVE_NAMESERVERS_RUNNING);
