...
public class NameRecord implements Comparable<NameRecord> {
  ...
  public NameRecord(String name, Set<Integer> activeNameServers, String activePaxosID,
                    ValuesMap values, int ttl, BasicRecordMap nameRecordDB) {
    ...
    this.nameRecordDB = nameRecordDB;
  }
   ...
   */
  public NameRecord(JSONObject jsonObject, BasicRecordMap nameRecordDB) throws JSONException {
   ...
   * @param allValues
   */
  public NameRecord(HashMap<ColumnField, Object> allValues, BasicRecordMap nameRecordDB) {
   ...
   * @param name
   */
  public NameRecord(String name, BasicRecordMap nameRecordDB) {
    hashMap = new HashMap<ColumnField, Object>();
    hashMap.put(NAME, name);
    this.nameRecordDB = nameRecordDB;
  }
  ...
  public void incrementLookupRequest() throws FieldNotFoundException {
    ...
    nameRecordDB.increment(getName(), incrementFields, values);
  ...
  public boolean updateKey(String key, ResultValue newValues, ResultValue oldValues,
    ...
    if (operation.equals(UpdateOperation.REMOVE_FIELD)) { // remove the field with name = key from values map.
      ...
      nameRecordDB.removeMapKeys(getName(), VALUES_MAP, keys);
      return true;
    ...
    if (updated) {
      ...
      nameRecordDB.update(getName(), NAME, null, null, VALUES_MAP, updatedFields, updatedValues);
//      valuesMap.get();
    }
    return updated;
  }
...
//    if (currentPaxosID != null && currentPaxosID.equals(paxosID)) {
    ...
    nameRecordDB.updateConditional(getName(), NAME, ACTIVE_PAXOS_ID, paxosID, updateFields, updateValues,
            null,null,null);
...
//    }
  ...
  public void handleNewActiveStart(Set<Integer> actives, String paxosID, ValuesMap currentValue)
    ...
    nameRecordDB.update(getName(), NAME, updateFields, updateValues);
