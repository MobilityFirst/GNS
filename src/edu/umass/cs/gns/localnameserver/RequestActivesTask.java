...
import edu.umass.cs.gns.clientCommandProcessor.*;
 ...
 *
 * @param <NodeIDType>
 * @see edu.umass.cs.gns.clientCommandProcessor.PendingTasks
...
public class RequestActivesTask<NodeIDType> extends TimerTask {
  ...
  RequestHandlerInterface<NodeIDType> handler;

  private long startTime;

  public RequestActivesTask(String name, int requestID, RequestHandlerInterface<NodeIDType> handler) {
    this.name = name;
