...
/**
 * Command to return the groups that a GNSProtocol.GUID.toString() is a member of formatted as a JSON Array.
 *
 * @author westy
 */
public class GetGroups extends AbstractCommand {
  ...
  public CommandResponse execute(InternalRequestHeader header, CommandPacket commandPacket, ClientRequestHandlerInterface handler) throws InvalidKeyException, InvalidKeySpecException,
    ...
    return new CommandResponse(ResponseCode.NO_ERROR, new JSONArray(GroupAccess.lookupGroupsLocally(header, guid, reader,
