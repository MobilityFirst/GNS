...
import edu.umass.cs.gnrs.nameserver.NSListenerUDP;
import edu.umass.cs.gnrs.nameserver.NameServer;
import edu.umass.cs.gnrs.packet.NameRecordStatsPacket;
...
import edu.umass.cs.gnrs.statusdisplay.StatusClient;
...
//		if (StartNameSer)
        ...
        ReplicaControllerRecord nameRecordPrimary = DBReplicaController.getNameRecordPrimary(selectionPacket.getName());
    ...
    private static void handleNameRecordStatsPacket(JSONObject json) {
        ...
        ReplicaControllerRecord nameRecordPrimary = DBReplicaController.getNameRecordPrimary(statsPacket.getName());
        if (nameRecordPrimary != null && nameRecordPrimary.isPrimaryReplica()) {
            // Propose to paxos.
    ...
    public static void applyNameRecordStatsPacket(String decision) {
        ...
        if (nameRecordPrimary != null && nameRecordPrimary.isPrimaryReplica())
        {
            ...
            DBReplicaController.updateNameRecordPrimary(nameRecordPrimary);
