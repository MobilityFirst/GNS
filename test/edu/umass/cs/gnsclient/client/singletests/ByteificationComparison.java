...
//            = GNSCommand.fieldRead(new String(Util.getRandomAlphanumericBytes(64)),
//                    new String(Util.getRandomAlphanumericBytes(64)), null);
...
//  @Test
//  // FIXME: THIS TEST IS FAILING at new CommandPacket(bytes)
//  public void test_201_FromCommandPacket_128B_Signed()
//          throws UnsupportedEncodingException, JSONException, ClientException,
//          NoSuchAlgorithmException, RequestParseException {
