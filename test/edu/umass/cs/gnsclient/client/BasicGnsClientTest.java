...
public class BasicGnsClientTest {
  ...
  public void test_2_NewRead() {
    ...
    try {
      ...
      JSONAssert.assertEquals("{\"sammy\":\"green\",\"sally\":{\"left\":\"eight\",\"right\":\"seven\"}}",
              actual, true);
    } catch (Exception e) {
    ...
    try {
      ...
      JSONAssert.assertEquals("{\"left\":\"eight\",\"right\":\"seven\"}", actual, true);
    } catch (Exception e) {
  ...
  public void test_4_HierarchicalACL() {
    ...
    try {
      ...
      JSONAssert.assertEquals(new JSONArray(Arrays.asList("Tango", "Sierra", "Alpha")).toString(), actual, true);
    } catch (Exception e) {
