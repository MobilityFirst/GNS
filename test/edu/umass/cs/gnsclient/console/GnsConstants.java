...
public class GnsConstants
{
  ...
  /**
   * stores the alias of a GUID, required in group membership to find alias using GUID
   */
  ...
  {
    return INACTIVE_PROXY_FIELD.equals(listName)
        || ACTIVE_PROXY_FIELD.equals(listName)
        || SUSPICIOUS_PROXY_FIELD.equals(listName)
        || INACTIVE_WATCHDOG_FIELD.equals(listName)
        || ACTIVE_WATCHDOG_FIELD.equals(listName)
        || SUSPICIOUS_WATCHDOG_FIELD.equals(listName)
        || INACTIVE_LOCATION_FIELD.equals(listName)
        || ACTIVE_LOCATION_FIELD.equals(listName)
