...
public class GeodeticCalculator
{
    ...
    public static GlobalCoordinate calculateEndingGlobalCoordinates(GlobalCoordinate start, double startBearing, double distance,
								     double[] endBearing) {
	return calculateEndingGlobalCoordinates(Ellipsoid.WGS84, start, startBearing, distance, endBearing);
    }
    ...
    * @return
    */
   public static GlobalCoordinate calculateEndingGlobalCoordinates(Ellipsoid ellipsoid, GlobalCoordinate start, double startBearing, double distance,
         double[] endBearing)
   {
      ...
      return new GlobalCoordinate(latitude, longitude);
   }
