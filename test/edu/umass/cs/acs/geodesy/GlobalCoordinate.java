 ...
 *
 */
package edu.umass.cs.acs.geodesy;

import edu.umass.cs.acs.goem.PointSimple;
import edu.umass.cs.acs.util.Format;
...
public class GlobalCoordinate implements Comparable<GlobalCoordinate>, Serializable {
  ...
  private void canonicalize() {
    // don't need more than 5 digits of precision here
    //mLatitude = (double)Math.round(mLatitude * 100000) / 100000;
    //mLongitude = (double)Math.round(mLongitude * 100000) / 100000;
    //
  ...
  public PointSimple toPoint() {
    return new PointSimple(mLongitude, mLatitude);
  }
