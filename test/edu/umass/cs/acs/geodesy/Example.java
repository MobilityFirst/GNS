...
public class Example {
  ...
  static void TwoDimensionalDirectCalculation() {
    ...
    GlobalCoordinate lincolnMemorial;
    lincolnMemorial = new GlobalCoordinate(38.88922, -77.04978);
    ...
    GlobalCoordinate dest = geoCalc.calculateEndingGlobalCoordinates(reference, lincolnMemorial, startBearing, distance, endBearing);
  ...
  static void TwoDimensionalCalculation() {
    ...
    GlobalCoordinate eiffelTower;
    eiffelTower = new GlobalCoordinate(48.85889, 2.29583);
